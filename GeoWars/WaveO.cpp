    ...
    if (newWave)
    {
        ...
        if (timer.Elapsed(waveDelay))
        {
            ...
            case 0:
                ...
                {
                    Start::scene->Add(new Orange(50, posY, 0), MOVING);
                    posY += 50;
                }
                break;
            case 1:
                ...
                {
                    Start::scene->Add(new Orange(posX, 50, 270), MOVING);
                    posX += 50;
                }
                break;
            case 2:
                ...
                for (int i = 0; i < numY; ++i)
                {
                    Start::scene->Add(new Orange(game->Width() - 50, posY, 180), MOVING);
                    posY -= 50;
                }
                break;
            case 3:
                ...
                for (int i = 0; i < numX; ++i)
                {
                    Start::scene->Add(new Orange(posX, game->Height() - 50, 90), MOVING);
                    posX -= 50;
                }
                break;
            }
